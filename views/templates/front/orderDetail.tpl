<section class="box" id="order-detail">
    <h1>
        {if !$shipback}
            ...
            {l s='front.order.detail.content' mod='shoprunback'} <span onclick="createShopRunBackReturn('{$createReturnLink nofilter}')" id="create-return">{l s='front.order.detail.link' mod='shoprunback'}</span>
        {else}
